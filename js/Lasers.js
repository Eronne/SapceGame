...
Lasers.prototype.createOne = function(x, y, direction) {
    //Création d'un nouveau laser aux positions et à la direction spécifiée
    this.lasers.push({
        x           : x,
        y           : y,
...
Lasers.prototype.update = function(obj) {
    ...
    for (var i = 0, laser; i < this.lasers.length; i++) {
        ...
        // Pour vérifier si un laser entre en collision avec un astéroïde, il faut tester tous les astéroïdes sur chaque laser,
        // d'où cette nouvelle boucle dans la boucle au dessus
